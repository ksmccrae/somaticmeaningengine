...
This index tracks Sensory Profiles in the Somatic Meaning Engine.

Sensory Profiles define perceived qualities. They do not define activation mechanics, fluid identity, sensory valence, pleasure, desire, symbolic meaning, authorial language, corpus truth, or consent.
...
| Candidate | Source Context | Reason Deferred |
|---|---|---|
| Paraurethral Glandular Fluid Sensory Profile | [[Female - Paraurethral Glandular Release Activation Profile]] | Requires fluid-boundary ambiguity handling |
| Menstrual Fluid Sensory Profile | [[Female - Menstruation Activation Profile]] | Requires cyclical/fluid sensory governance |
| Female - Perineum Sensory Profile | [[Female - Pelvic Floor Contraction Activation Profile]] / Mirror context | Requires distinction from pelvic-floor primary anchor |

## Sensory Quality Governance Note

Sensory qualities such as pressure, tension, pulsing, support, ache, fullness, wetness, surface presence, texture, flow, odour, and taste are currently treated as controlled candidate values.

They are not standalone ontology nodes unless promoted later.

Do not wikilink sensory-quality values unless a governed Sensory Quality node exists.

## Valence Governance Note

Sensory valence categories such as pleasure, discomfort, neutral valence, ambivalent valence, unwanted sensation, relief, and intensity-without-valence are currently treated as controlled candidate values or governed register entries.

They are not standalone ontology nodes unless promoted later.

Do not infer consent from any valence category.
